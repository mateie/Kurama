    ...
    async run(interaction: CommandInteraction) {
        ...
        const embed = this.client.util.embed()
            ...
            .addFields([
                ...
                { name: 'Up Since', value: `<t:${Math.floor(this.client.readyTimestamp as number / 1000)}:R>`, inline: true },
                { name: 'Node.js', value: process.version, inline: true },
                { name: 'Discord.js', value: version, inline: true },
                { name: 'Ping', value: `${this.client.ws.ping}ms`, inline: true },
                { name: 'Commands', value: `${this.client.commandHandler.commands.size}`, inline: true },
                { name: 'Events', value: `${this.client.eventHandler.events.size}`, inline: true },
